...
def main():
    ...
    enemy1 = player.Enemy()
    planebiulist = []
    # jshuRect = pygame.Rect(plane1.x + 29, plane1.y, 21, 97)
    # jhengRect = pygame.Rect(plane1.x, plane1.y + 37, 97, 23)
    while True:
        screen.blit(bg, (0, 0))
        ...
        plane1.blit(screen, enemy1)
        enemy1.blit(screen)
        if enemy1.live == 0:
            out_string(screen, "爆炸", (0, 0, 0), (200, 200), 50)
            print("dead")
